...
class ApuracaoInformacaoExtra extends Model
{
    ...
    {
        return '<a download class="download" href="' . asset(public_path() . 'storage/anexos/' . $this->toAnexo()->referencia . '/' . $this->toAnexo()->id_referencia . '/' . $this->toAnexo()->arquivo) . '" title="Clique para fazer download do arquivo"><i class="fa fa-download"></i></a>';
    }
