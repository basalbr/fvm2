...
use App\Notifications\SolicitacaoAlteracaoCanceled;
...
class CancelAlteracao
{
    ...
    public static function handle($idAlteracao)
    {
        ...
        try {
            ...
            $alteracao->status = 'Cancelado';
            $alteracao->save();

            $alteracao->usuario->notify(new SolicitacaoAlteracaoCanceled($alteracao));
            DB::commit();
