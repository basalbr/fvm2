...
<div class="modal animated fadeInUpBig" id="modal-access" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" method="POST" id="login-form" data-validation-url="{{route('validateUserLogin')}}" action="">
                ...
                <div class="modal-footer">
                    <a href="" data-dismiss="modal" data-toggle="modal" data-target="#modal-forgot" class="btn btn-link" id="forgotPasswordLink">Esqueci minha senha</a>
