...
@section('top-title')
    <a href="{{route('listNoticiasToAdmin')}}">Notícias</a> <i class="fa fa-angle-right"></i> {{$noticia->titulo}}
@stop
@section('js')
    @parent
            ...
            <div role="tabpanel" class="active tab-pane animated fadeIn" id="todo">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="titulo_destaque" value="{{$noticia->titulo_destaque}}"/>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
                        <label>Título *</label>
                        <input class="form-control" name="titulo" value="{{$noticia->titulo}}"/>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
                        <label>Subtítulo *</label>
                        <input class="form-control" name="subtitulo" value="{{$noticia->subtitulo}}"/>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
                        <label>Data de publicação *</label>
                        <input class="form-control date-mask" name="data_publicacao"  value="{{$noticia->data_publicacao->format('d/m/Y')}}"/>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
                        <label>Capa *</label>
                        <input type="hidden" value="{{$noticia->capa}}" name="capa">
                        <input class="form-control" type="file" name="nova_capa"/>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="form-group">
                        <label>Conteúdo *</label>
                        <textarea class="form-control" name="conteudo">{{$noticia->conteudo}}</textarea>
                    </div>
                </div>
