                ...
                @if($demissoesPendentes->count())
                    @foreach($demissoesPendentes as $demissao)
                        <tr>
                            ...
                            <td><a href="{{route('showUsuarioToAdmin', [$demissao->funcionario->empresa->usuario->id])}}">
                                    {{$demissao->funcionario->empresa->usuario->nome}}
                                </a></td>
                            <td>{{$demissao->data_demissao->format('d/m/Y')}}</td>
                            <td>
                                <a class="btn btn-primary" href="{{route('showDemissaoToAdmin', $demissao->id)}}" title="Visualizar">
