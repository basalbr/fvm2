...
<div class="col-sm-5">
    <div class="form-group">
        ...
        <input type="text" class="form-control money-mask" value="{{$contrato->getSalario()}}"
...
<div class="col-sm-4">
    <div class="form-group">
        ...
        <input type="text" class="form-control date-mask" value="{{$contrato->data_admissao->format('d/m/Y')}}"
               name="contrato[data_admissao]"/>
    </div>
</div>
...
<div class="col-sm-5">
    <div class="form-group">
        ...
        <input type="text" class="form-control" value="{{$contrato->valor_vale_transporte}}"
               name="contrato[valor_vale_transporte]"/>
    </div>
</div>
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <input type="text" class="form-control money-mask" value="{{$contrato->desconto_assistencia_medica}}"
               name="contrato[desconto_assistencia_medica]"/>
    </div>
</div>
...
<div class="col-sm-9 col-lg-6">
    <div class="form-group no-border">
        <label class="checkbox checkbox-styled radio-success">
            <input type="checkbox" value="1" name="contrato[desconta_vale_transporte]"
                   id="desconta_vale_transporte" {{$contrato->desconta_vale_transporte ? 'checked="checked"' : ''}}><span></span>
...
<div class="col-sm-3 col-lg-6">
    <div class="form-group no-border">
        <label class="checkbox checkbox-styled radio-success">
            <input type="checkbox" value="1" name="contrato[professor]"
                   id="professor" {{$contrato->professor ? 'checked="checked"' : ''}}><span></span> Professor
        </label>
        <div class="clearfix"></div>
    </div>
</div>
...
<div class="col-sm-6">
    <div class="form-group no-border">
        <label class="checkbox checkbox-styled radio-success">
            <input type="checkbox" value="1" name="contrato[primeiro_emprego]"
                   id="primeiro_emprego" {{$contrato->primeiro_emprego ? 'checked="checked"' : ''}}><span></span>
            Primeiro
            emprego
        </label>
        <div class="clearfix"></div>
