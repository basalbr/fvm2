...
@section('content')
    <!-- Nav tabs -->
    @include('dashboard.imposto_renda.edit.components.tabs')
    ...
    <!-- Tab panes -->
        <div class="tab-content">
            ...
            @include('dashboard.imposto_renda.edit.components.tab-geral')
            @include('dashboard.imposto_renda.edit.components.tab-rendimentos')
            @include('dashboard.imposto_renda.edit.components.tab-recibos')
            @include('dashboard.imposto_renda.edit.components.tab-doacoes')
            @include('dashboard.imposto_renda.edit.components.tab-bens')
            @include('dashboard.imposto_renda.edit.components.tab-dividas')
            @include('dashboard.imposto_renda.edit.components.tab-outros')
            @include('dashboard.imposto_renda.edit.components.tab-dependentes')
            @include('dashboard.imposto_renda.edit.components.tab-documentos-enviados')
            <div class="clearfix"></div>
...
@section('modals')
    @parent
    @include('dashboard.imposto_renda.edit.modals.dependente')
    @include('dashboard.imposto_renda.edit.modals.remove-dependente')
@stop
