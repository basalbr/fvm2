...
<div role="tabpanel" class="tab-pane active animated fadeIn" id="tab-geral">
    ...
    <div class="ano_anterior_div">
        @include('dashboard.imposto_renda.edit.components.upload', ['descricao'=>'Cópia do recibo da declaração de '.$anoAnterior, 'referencia'=>'recibo_anterior'])
        @include('dashboard.imposto_renda.edit.components.upload', ['descricao'=>'Cópia da declaração de '.$anoAnterior, 'referencia'=>'declaracao_anterior'])
    </div>
    <div class="documentos-declaracao" style="display: none">
        @include('dashboard.imposto_renda.edit.components.upload', ['descricao'=>'RG', 'referencia'=>'rg'])
        <div class="col-xs-12">
            <div class="form-group">
        ...
        @include('dashboard.imposto_renda.edit.components.upload', ['descricao'=>'CPF', 'referencia'=>'cpf'])
        @include('dashboard.imposto_renda.edit.components.upload', ['descricao'=>'Título de Eleitor', 'referencia'=>'titulo_eleitor'])
    </div>
    @include('dashboard.imposto_renda.edit.components.upload', ['descricao'=>'Comprovante de Residência', 'referencia'=>'comprovante_residencia'])
    <div class="col-xs-12">
        <div class="form-group">
    ...
    @include('dashboard.imposto_renda.edit.components.text', ['descricao'=>'Descrição da Ocupação *', 'referencia'=>'ocupacao_descricao', 'valor'=>$ir->declarante->ocupacao])
