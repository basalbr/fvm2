...
@section('content')
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation">
            <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><i
                ...
                Mensagens
                <span class="badge message-badge">{{$decimoTerceiro->mensagens()->where('lida','=',0)->where('from_admin','=',1)->count()}}</span>
            </a>
        </li>
        <li role="presentation">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="active tab-pane animated fadeIn" id="principal">
            ...
            {{csrf_field()}}
            <div class="col-xs-12">
                <p>Abaixo se encontram os documentos relacionados ao décimo terceiro enviados
                    em {{$decimoTerceiro->created_at->format('d/m/Y')}}.</p>
            </div>
            <div class="col-xs-12">
                <div class="form-group">
                    <label>Empresa *</label>
                    <div class="form-control">
                        <a href="{{route('showEmpresaToUser', $decimoTerceiro->id_empresa)}}">
            ...
            @include('dashboard.components.uploader.default',['lock'=>true, 'reference'=>$decimoTerceiro->getTable(), 'referenceId'=>$decimoTerceiro->id, 'anexos'=>$decimoTerceiro->anexos])
        </div>
        <div role="tabpanel" class="tab-pane animated fadeIn" id="messages">
            @include('dashboard.components.chat.box', ['model'=>$decimoTerceiro])
        </div>
