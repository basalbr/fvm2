...
<div class="col-sm-4">
    <div class="form-group">
        ...
        <input type="text" class="form-control number-mask" value="" name="mensalidade[qtde_funcionario]"/>
    </div>
</div>
<div class="col-sm-8">
    <div class="form-group">
        <label for="qtde_documento_fiscal">Quantidade de documentos fiscais recebidos e emitidos mensalmente *</label>
        <input type="text" class="form-control number-mask" value="" name="mensalidade[qtde_documento_fiscal]"/>
    </div>
</div>
<div class="clearfix"></div>
